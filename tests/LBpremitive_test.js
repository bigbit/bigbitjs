const LBSequence = require("../src/LB/LBSequencePremitive");
...
describe ('Linked Byte Format', () => {
    ...
    it('should skip extra bytes a number', () => {
        ...
        expect( LBSequence.decode([ 98, 1 , 137], 1)  ).toEqual({ val: 1, len: 1});
        expect( LBSequence.decode([ 1 , 137])  ).toEqual({ val: 1, len: 1});
    });
